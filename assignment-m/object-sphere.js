...
This file is a DIRECT COPY of the "sphere.js" file
but with my own comments substituting in for those
from the original file.

I have included this file for referencing purposes.
*/
...
{ 
	...
	//Pushes in the vertices for the sphere
	//using sphere-to-rectangle coordinates.
    for (j = 1; j < nStacks; ++j) 
	{
        var phi = j * dPhi;
        var z = Math.cos(phi);
	...
	//first and last stacks of the sphere.
